...
async function adminGetWaitlist(req, res) {
    ...
    <tr>
      ...
      <td>
        ${(e.interests || []).map(i => `<span style="display:inline-block;padding:0.2rem 0.6rem;border:1px solid #222;font-size:0.55rem;letter-spacing:0.1em;text-transform:uppercase;color:#666;margin:0.1rem;">${i}</span>`).join('')}
      </td>
